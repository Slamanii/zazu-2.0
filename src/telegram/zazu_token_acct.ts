...
bot.onText(/\/start/, async (msg: Message) => {
    bot.sendMessage(msg.chat.id, "Zazu is at your service!", mainMenu)
...
export const preflightResults = new Map<number, {
            canServe: boolean
